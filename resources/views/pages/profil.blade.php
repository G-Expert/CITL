                ...
                <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3 lh-1">
                                <div>
                                    <span class="font-size-xs text-uppercase font-weight-semi-bold">Export Livré</span>
                                </div>
                                <div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3 lh-1">
                                <div>
                                    <span class="font-size-xs text-uppercase font-weight-semi-bold">Imports livrés</span>
                                </div>
                                <div>
