          ...
          <div class="row">
              <div class="col-lg-12 col-md-12 col-12">
                  <div class="border-bottom pb-4 mb-4 d-lg-flex justify-content-between align-items-center">
                      <div>
                          <h1 class="mb-0 h2 font-weight-bold">Importations soldées [ {{$expNb}} Imports]</h1>
                      </div>
                      <div class="d-flex">
                          <a href="/new_importLV" class="btn btn-warning">Nouvelle</a><br>
                      </div>
                    ...
                    <div class="row">
                       <div class="mb-4 col-lg-6">
                         ...
                         <select class="selectpicker attribut" id="basic-example" name="attribut" data-width="100%">
                           <option value="codeImp">Code</option>
                           <option value="d1">Dossier</option>
                           <option value="d2">FDI</option>
                           <option value="d3">BSC</option>
                           <option value="d4">RCFV</option>
                           <option value="d5">TD</option>
                           <option value="d6">DD</option>
                           <option value="d7">PFP</option>
                           <option value="d8">Liv</option>
                           <option value="d9">VCD</option>
                           <option value="d10">BED</option>
                         </select>
                       </div>
                       <div class="mb-4 col-lg-6">
