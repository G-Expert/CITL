<?php
  $exp = ExportClientEtat($_SESSION['i'],1);
  $expNb = count($exp);
  //dd($exp);
?>
<!-- Wrapper -->
          ...
          <div class="row">
              <div class="col-lg-12 col-md-12 col-12">
                  <div class="border-bottom pb-4 mb-4 d-lg-flex justify-content-between align-items-center">
                      <div>
                          <h1 class="mb-0 h2 font-weight-bold">Exportations soldées [ {{$expNb}} Exports]</h1>
                      </div>
                      {{-- <div class="d-flex">
                          <a href="clients_liste" class="btn btn-warning">Clients</a><br>
                      </div> --}}
                                      ...
                                      <p class="mb-0">
                                        ...
                                        {{-- <span class="badge badge-info">En cours</span><br> --}}
                                          ...
                                          <span class="text-dark">
                                            <br><a href="#" class="details" id="{{$value->idExport}}"><i class="fe fe-eye font-size-lg text-warning"></i> <br>Voir plus</a>
